 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class CodingStandard_TestSuite_Inc_AllSniffs
{
    ...
    public static function suite()
    {
        ...
        $standardDir = STANDARDS_PATH.DIRECTORY_SEPARATOR.STANDARD_NAME.DIRECTORY_SEPARATOR.'Tests'.DIRECTORY_SEPARATOR;
        ...
        foreach ($di as $file) {
            ...
            if (substr($file->getFilename(), 0, 1) === '.' || pathinfo($file->getFilename(), PATHINFO_EXTENSION) !== 'php') {
                continue;
            }

            $filePath  = $file->getPathname();
            $className = str_replace(STANDARDS_PATH.DIRECTORY_SEPARATOR, '', $filePath);
